<template>
    <section class="bg-gray-800 xl:w-72">
        <div class="flex justify-between px-4 py-3 xl:hidden">
            ...
            <input placeholder="Search by keywords" class="block w-full bg-gray-900 text-white rounded-lg px-10 pr-4 py-2 focus:outline-none focus:bg-white focus:text-gray-900">
            </div>
            <button type="button" class="ml-4 flex items-center hover:bg-gray-600 rounded-lg shadow pl-3 pr-4 foucs:outline-none focus:shadow-outline"
                @click="toggle"
        ...
        <form v-show="isOpen" class="xl:h-full xl:flex xl:flex-col xl:justify-between">
            <div class="lg:flex xl:block xl:overflow-y-auto">
                <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
                    <div class="flex flex-wrap -mx-2">
                        <label class="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                            ...
                            <select class="form-select block w-full mt-1 shadow text-white focus:bg-gray-600">
                                <option>4</option>
                            </select>
                        </label>
                        <label class="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                ...
                <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
                    <span class="text-sm font-semibold text-gray-500 block">Property Type</span>
                ...
                <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
                    <span class="text-sm font-semibold text-gray-500 block">Amenities</span>
            ...
            <div class="bg-gray-900 px-4 py-4">
                <button class="block w-full sm:w-auto sm:inline-block xl:w-full xl:block bg-indigo-500 font-semibold text-white px-4 py-2 rounded-lg hover:bg-indigo-400">Update results</button>
            </div>
        </form>
    </section>
</template>
...
export default {
    ...
    data() {
        return {
            //remember to change to false for default close behaviour
            isOpen: true,
        }
    }, 
    methods: {
